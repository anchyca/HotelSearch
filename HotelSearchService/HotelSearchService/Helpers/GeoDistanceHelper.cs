namespace HotelSearchService.Helpers
{
    public static class GeoDistanceHelper
    {
        ...
        /// <param name="lon2">The longitude of the second point.</param>
        /// <returns>The distance in meters.</returns>
        public static double GetEuclideanDistance(double lat1, double lon1, double lat2, double lon2)
        {
        ...
        /// <param name="lon2">The longitude of the second point.</param>
        /// <returns>The distance in meters.</returns>
        public static double GetLawOfCosinesDistance(double lat1, double lon1, double lat2, double lon2)
        {
            var φ1 = lat1 * Math.PI / 180;
            var φ2 = lat2 * Math.PI / 180;
